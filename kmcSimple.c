...
Output: ./Outfiles/avh.txt, a (num_times +1) x L array, storing avg. height profile at 0, T_1,T_2,...
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
int main(int argc, char *argv[])
{
	...
	char str_avh[100] = "./Outfiles/avh.txt"
